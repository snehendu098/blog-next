...
const IntroComponent = () => {
  return (
    <div className="w-full bg-white mdx:flex-col mdx:justify-center mdx:items-center mt-2 flex md:flex-row-reverse shadow-md">
      <div className="w-1/2 flex items-center justify-center p-10 mdx:mt-3 mdx:p-0">
        <Image src={pic} alt="hello" height={300} width={300} />
      </div>
      <div className="md:w-1/2 p-2 m-2 mdx:p-1">
        ...
        <p className="text-3xl p-7 mdx:p-5 mdx:pt-0 mdx:text-xl">
          ...
          learnings through{" "}
          <Link href={"/articles"}>
            <span className="text-blue-600 cursor-pointer">ARTICLES</span>
          </Link>
        </p>
